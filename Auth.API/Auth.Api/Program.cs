...
Log.Logger = new LoggerConfiguration()
    .MinimumLevel.Debug()
    .WriteTo.Console()
    .WriteTo.File("c:/logs/AuthApi/log-.txt",
...
builder.Services.AddDbContext<ApiAuthDbContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("ApiAuthDbConnectionString")));
...
using (var scope = app.Services.CreateScope())
{
    ...
    var context = services.GetRequiredService<ApiAuthDbContext>();
